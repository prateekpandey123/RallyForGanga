...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid" style="background-color: green;">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample05">
            <ul class="navbar-nav pl-md-5 ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="portfolio.php">Gallery</a>
              </li>
              <li class="nav-item">
    ...
    <div class="inner-page">
      <div class="slider-item overlay" style="background-image: url('images/walpaper/dry1.jpg'); height: 667px;"
        data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-lg-9 text-center col-sm-12 element-animate">
              <h1 class="mb-4">Rally For Ganga</h1>
              <p class="custom-breadcrumbs"><a href="index.php">Home</a> <span class="mx-3">/</span> Blog</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <a href="portfolio-single.php" class="work-thumb">
              ...
              <img src="images/work1.jpg" alt="Image" class="img-fluid">
            </a>
            <a href="portfolio-single.php" class="work-thumb">
              <div class="work-text">
                <!-- <h2>Work Name Here</h2>
              ...
              <img src="images/meet2.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-6">
            <a href="portfolio-single.php" class="work-thumb">
              ...
              <img src="images/work2.jpg" alt="Image" class="img-fluid">
            </a>
            <a href="portfolio-single.php" class="work-thumb">
              <div class="work-text">
               <!--  <h2>Work Name Here</h2>
              ...
              <img src="images/work3.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
        </div>
        <div class="section portfolio-section">
        ...
        <div class="row">
          <div class="col-lg-6">
            <a href="portfolio-single.php" class="work-thumb">
              ...
              <img src="images/work111.jpg" alt="Image" class="img-fluid">
            </a>
            <a href="portfolio-single.php" class="work-thumb">
              <div class="work-text">
                <!-- <h2>Work Name Here</h2>
              ...
              <img src="images/work44.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-6">
            <a href="portfolio-single.php" class="work-thumb">
              ...
              <img src="images/work222.jpg" alt="Image" class="img-fluid">
            </a>
            <a href="portfolio-single.php" class="work-thumb">
              <div class="work-text">
                <!-- <h2>Work Name Here</h2>
              ...
              <img src="images/work333.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-6">
            <a href="portfolio-single.php" class="work-thumb">
              ...
              <img src="images/work1111.jpg" alt="Image" class="img-fluid">
            </a>
            <a href="portfolio-single.php" class="work-thumb">
              <div class="work-text">
                <!-- <h2>Work Name Here</h2>
              ...
              <img src="images/work4444.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="col-lg-6">
            <a href="portfolio-single.php" class="work-thumb">
              ...
              <img src="images/work2222.jpg" alt="Image" class="img-fluid">
            </a>
            <a href="portfolio-single.php" class="work-thumb">
              <div class="work-text">
                <!-- <h2>Work Name Here</h2>
              ...
              <img src="images/work3333.jpg" alt="Image" class="img-fluid">
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-7">
          ...
          <p class="text-white mb-5">The Ganga Water Rally is the first major water sporting events of its kind in the state. Here, the adventurous persons would be taken on a nerve rattling sojourn down the Ganga from Prayagraj to Varanasi through Mirzapur and Chunar.</p>
          <p class="mb-0"><a href="contact.php" class="glow-on-hover btn-outline-light px-4 py-3">Get In Touch!</a></p>
        </div>
      </div>
    </div>
  </div>
