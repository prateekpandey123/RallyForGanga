  ...
  <body>
    <header>
      ...
      <nav class="navbar fixed-top navbar-expand-lg navbar-dark blue-gradient scrolling-navbar font-weight-bold">
        <div class="container">
          <!-- Brand -->
          <a class="navbar-brand" ID="HyperLink6"  NavigateUrl="index.php">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link active" ID="HyperLink3"  NavigateUrl="index.php">Home<span class="sr-only">(current)</span></a>
                
              </li>
              <li class="nav-item">
                <a class="nav-link" ID="HyperLink1"  Text="About Us" NavigateUrl="aboutus.php"></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" ID="HyperLink2"  Text="Donate" NavigateUrl="donate.php"></a>
              </li>
              <li class="nav-item">
                <a ID="HyperLink4" class="nav-link"  NavigateUrl="request.php">Request Page</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" ID="HyperLink5"  NavigateUrl="testimonial.php">Testimonial</a>
              </li>
              <li class="nav-item">
                <a ID="HyperLink8" class="nav-link"  NavigateUrl="index.php">
